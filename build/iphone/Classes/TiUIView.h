...
/**
 Base class for all PMXFramwork views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the PMXFramwork view hierarchy (such as wrapped iOS UIViews) was touched.
