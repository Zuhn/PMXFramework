...
//@interface PMXFramworkObject : NSObject
//@end

@interface PMXFramworkObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PMXFramworkObject class]])
		{
			for (NSString *key in [[(PMXFramworkObject*)o modules] allKeys])
			{
