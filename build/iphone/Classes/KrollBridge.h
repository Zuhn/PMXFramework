...
@interface PMXFramworkObject : KrollCoverageObject {
#else
@interface PMXFramworkObject : KrollObject {
#endif
@private
...
extern NSString * PMXFramwork$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PMXFramworkObject *_pmxframwork;
    KrollObject* console;
	BOOL shutdown;
